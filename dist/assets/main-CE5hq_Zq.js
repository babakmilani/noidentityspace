import"./styles-Cu5RuLse.js";window.toggleMenu=function(){const e=document.getElementById("navLinks");e&&e.classList.toggle("active")};window.handleSubmit=function(e){e.preventDefault();const t=e.target,n=t.closest(".community-box");console.log("Subscription form submitted. Data:",new FormData(t)),n?n.innerHTML=`
